...
class _HubChatAiScreenState extends State<HubChatAiScreen>
            ...
            ..._children.map((child) {
              ...
              return ListTile(
                ...
                leading: CircleAvatar(
                  backgroundColor:
                      isSelected ? AppColors.primary : Colors.white10,
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const SizedBox(height: 16),
        const Text('Ask me your first question!',
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
        ...
        Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Text('Guardian AI is writing',
                  style: TextStyle(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: isUser
                          ...
                          : null,
                      color: isUser ? null : const Color(0xFF1E1E35),
                      borderRadius: BorderRadius.only(
    ...
    for (final rawLine in lines) {
      ...
      if (headingMatch != null) {
        ...
        widgets.add(Padding(
          ...
          child: Text(title,
              style: TextStyle(
                color: level == 1 ? Colors.white : AppColors.accentTeal,
                fontSize: level == 1
                    ? fs + 2
                    : level == 2
                        ? fs + 1
  ...
  Widget _buildInputArea(AppStateManager stateManager) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF0D0D1A).withValues(alpha: 0.98),
        border: Border(
      ...
      child: SafeArea(
        child: Row(children: [
          ...
          AnimatedContainer(
            ...
            height: 46,
            decoration: BoxDecoration(
              color: _isTyping ? Colors.white10 : AppColors.primary,
              shape: BoxShape.circle,
              boxShadow: _isTyping
                  ? null
                  : [
